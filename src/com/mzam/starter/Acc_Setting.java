	...
	public void onResume(){
		super.onResume();{
	     ...
	     // ListView Item Click Listener
			...
			ParseQuery<ParseUser> privacy = ParseQuery.getUserQuery();
    		privacy.getInBackground(current.getObjectId(),new GetCallback<ParseUser>(){

				@Override
				public void done(ParseUser object, ParseException e) {
					// TODO Auto-generated method stub
					if(object.getString("profile_privacy").isEmpty())
			        	sw.setChecked(false);
			        else if(object.getString("profile_privacy").equals("Private"))
						sw.setChecked(true);
					else
						sw.setChecked(false);
				}
